...
<body>
    ...
    <div class="container vh-50 shadow-lg mt-3">
        <div class="d-flex">
            ...
            <div class="carda mt-3">
                <div class="container">
                    <h5 class="text-center">Team COBRA!</h5>
                    <div class="row">
    ...
    <div class="container shadow-lg mt-3">
        Contact us: <br>
        <i class="fa fa-phone"></i> +880172440342 <i class="fa fa-envelope"></i> BAUSTCSE@gmail.com <i class="fa fa-fax"></i> 000-555 <i class="fa fa-home"></i> CSE, BAUST <i class="fa fa-facebook"></i> teamcobra <i class="fa fa-twitter"></i> teamcobra <i class="fa fa-linkedin"></i> teamcobra
    </div>
    <div>
